...
2. **Optimal Hyperparameters.**
   ...
   3. **Cosine scheduler is prevalent.**
      ...
      - Below is our experiment for CPM.
       ...
       <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/H2.3.scheduler.png" alt="" width="300" height="200"> 
   ...
   4. **Cosine learning rate's period should be set to the end step.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/H2.4.scheduler_period.png" alt="" width="500" height="200">
...
3. **Predictable Scaling.**
   1. **Pass rate on human eval can be predicted with 1/10000 compute.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/H3.1.predictable_scaling.png" alt="" width="400" height="250">
...
5. **Data Mixture**
   ...
   2. **Data portion is important.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/H5.2.data_portion.png" alt="" width="600" height="200">
...
1. **Emergent ability**
   1. **Emergent ability is observed with models ~ 50B or larger**
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W1.1.emergent_abilities.png" alt="" width="600" height="300">
   ...
   2. **Popular method only works on large models.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W1.2.delta_tuning.png" alt="" width="300" height="230">
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W1.2.cot.png" alt="" width="300" height="200">
   ...
   1. **Inverse (U-shape) scaling**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W1.3.u-shape.png" alt="" width="300" height="250">
...
1. **Training Dynamics.**
   1. **Double Descent phenomenon is observed.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W2.1.double_descent.png" alt="" width="550" height="200">
   ...
   2. **Grokking phenomenon might contribute to generalization.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W2.2.Grokking.png" alt="" width="320" height="250">
   ...
   3. **Modularity emerges in LLM.**
      ...
      <img src="https://github.com/OpenBMB/BMPrinciples/blob/main/figs/W2.3.Modularity_Emergence.png" alt="" width="500" height="230">
